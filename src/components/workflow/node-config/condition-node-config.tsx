            ...
            {branch.conditions.length > 1 && (
              <>
                <div className="flex-1 w-full flex justify-end items-end">
                  <div className="h-[calc(100%-1rem)] w-1/2 border-l border-dashed border-t rounded-tl-full" />
                </div>
                ...
                <div className="flex-1 w-full flex justify-end items-start">
                  <div className="h-[calc(100%-1rem)] w-1/2 border-l border-dashed border-b rounded-bl-full" />
                </div>
              </>
            )}
          </div>
