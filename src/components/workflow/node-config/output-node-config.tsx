...
import type { OutputNodeData, UINode } from "lib/ai/workflow/workflow.interface";
...
export const OutputNodeDataConfig = memo(({
  data,
}: {
  data: OutputNodeData;
}) => {
...
export const OutputNodeDataOutputStack = memo(({
  data,
}: { data: OutputNodeData }) => {
