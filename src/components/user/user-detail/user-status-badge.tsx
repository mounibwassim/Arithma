...
import type { UpdateUserBanStatusActionState } from "@/app/api/admin/validations";
    ...
    const badgeElement = user.banned ? (
      ...
      <Badge
        ...
        className={cn(
          ...
          canModify &&
            "cursor-pointer hover:bg-green-500/25 transition-colors flex items-center gap-1",
        )}
      >
        {tCommon("active")}
        {canModify && <Edit2 className="size-2.5!" />}
