...
import type { UpdateUserActionState } from "@/app/api/user/validations";
          ...
          <div className="grid gap-4 sm:grid-cols-2 pt-4 border-t">
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium" data-testid="user-created-at">
                {format(new Date(currentUser.createdAt), "d MMMM yyyy p")}
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium" data-testid="user-updated-at">
                {format(new Date(currentUser.updatedAt), "d MMMM yyyy p")}
              </p>
            </div>
          </div>
