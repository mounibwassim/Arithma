...
import type { ChatExportSummary } from "app-types/chat-export";
...
export function UserInstructionsContent() {
  ...
  const botNameExamples = useMemo(
    () => [
      t("Chat.ChatPreferences.botNameExample1"),
      t("Chat.ChatPreferences.botNameExample2"),
      t("Chat.ChatPreferences.botNameExample3"),
      t("Chat.ChatPreferences.botNameExample4"),
      t("Chat.ChatPreferences.botNameExample5"),
    ],
    [],
  );
