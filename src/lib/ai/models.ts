...
const {
	...
	visionUnsupportedModels: openaiCompatibleVisionUnsupportedModels,
...
const allVisionUnsupportedModels = new Set([
	...openaiCompatibleVisionUnsupportedModels,
]);
...
export const isVisionUnsupportedModel = (model: LanguageModel) => {
	return allVisionUnsupportedModels.has(model);
};
...
export const customModelProvider = {
	modelsInfo: Object.entries(allModels).map(([provider, models]) => ({
		...
		models: Object.entries(models).map(([name, model]) => ({
			...
			isImageInputUnsupported: isVisionUnsupportedModel(model),
