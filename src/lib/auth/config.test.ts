...
describe("Auth Config", () => {
  beforeEach(() => {
    ...
    process.env.GOOGLE_FORCE_ACCOUNT_SELECTION = undefined;
    process.env.MICROSOFT_CLIENT_ID = undefined;
    process.env.MICROSOFT_CLIENT_SECRET = undefined;
    process.env.MICROSOFT_TENANT_ID = undefined;
    process.env.MICROSOFT_FORCE_ACCOUNT_SELECTION = undefined;
    process.env.DISABLE_EMAIL_SIGN_IN = undefined;
    process.env.DISABLE_SIGN_UP = undefined;
  });
