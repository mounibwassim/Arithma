...
describe("s3-file-storage", () => {
  beforeEach(() => {
    ...
    process.env.FILE_STORAGE_S3_PUBLIC_BASE_URL = undefined;
    process.env.FILE_STORAGE_S3_ENDPOINT = undefined;
    process.env.FILE_STORAGE_S3_FORCE_PATH_STYLE = undefined;
  });
