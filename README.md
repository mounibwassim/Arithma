...
| `BETTER_AUTH_URL` | The base URL of the application (e.g., `https://arithma.vercel.app`). | Yes |
...
pnpm dev
```
Navigate to [https://arithma.vercel.app](https://arithma.vercel.app) to view the application in your browser.
...
- **URL:** [https://arithma.vercel.app/admin/login](https://arithma.vercel.app/admin/login)
